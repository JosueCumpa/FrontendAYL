...
export default function AgregarBanco({ type = "agregar", updateBancos }) {
    ...
    try {
      if (type === "agregar") {
        ...
        await toast.promise(axios.post(url, data, { headers }), {
          loading: "Registrando...",
          success: "Banco Registrado",
          error: "Error al registrar Banco! Verifique los campos",
        });
      }
